  ...
  <form @submit.prevent="updateUserProfile" class="q-pa-none">
    ...
    <div class="profile-row-items full-width q-my-md">
      ...
      <div class="q-pa-xs">
        ...
        <div class="profile-input">
          <q-input dense outlined v-model="user_details.profession" />
        </div>
      </div>
    </div>
    ...
    <div class="profile-row-items full-width q-my-md">
      <div class="q-pa-xs ">
        ...
        <div class="profile-input">
          <q-input dense outlined v-model="user_details.institution" />
        </div>
      </div>
      <div class="q-pa-xs">
        <div class="profile-title">Title</div>
        <div class="profile-input">
          <q-input dense outlined v-model="user_details.title" />
        </div>
      </div>
    </div>
    <!-- update link button -->
...
export default {
  ...
  methods: {
    // populate form data
    populateForm() {
      for (let [key, value] of Object.entries(this.user_details)) {
        this.user_details[key] = this.getAuthUserDetails[key]
      }
    },
